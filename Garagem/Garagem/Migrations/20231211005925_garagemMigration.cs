        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorFIPE = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    ValorVenda = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Observacoes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IdMarca = table.Column<string>(type: "text", nullable: true),
                    IdModelo = table.Column<string>(type: "text", nullable: true),
